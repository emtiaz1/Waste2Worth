                        ...
                        <div class="achievements-list">
                            <div class="achievement-card">
                                ...
                                <div>
                                    ...
                                    <div class="achievement-earned">Earned by: <span
                                            class="user-link">EcoWarrior123</span>
                                    </div>
                                </div>
                            </div>
                            <div class="achievement-card">
                                ...
                                <div>
                                    ...
                                    <div class="achievement-earned">Earned by: <span class="user-link">GreenHero</span>
                                    </div>
                                </div>
                            </div>
                            <div class="achievement-card">
                                ...
                                <div>
                                    ...
                                    <div class="achievement-earned">Earned by: <span
                                            class="user-link">EarthGuardian</span>
                                    </div>
                                </div>
                            </div>
                        </div>
