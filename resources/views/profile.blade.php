    ...
    <div class="layout" id="mainLayout">
        <div class="profile-container">
            ...
            <div class="tab-content">
                    ...
                    <div class="profile-display">
                        ...
                        <div class="section">
                            ...
                            <div class="tags-section">
                                ...
                                @if((!$profile->interests || count($profile->interests) == 0) && (!$profile->skills || count($profile->skills) == 0))
                                    <div class="empty-state">
                ...
                <div id="activity-tab" class="tab-pane">
                    <div class="activity-section">
                        ...
                        <div class="token-history">
                            @if($profile && $profile->token_usages && count($profile->token_usages) > 0)
                                <ul class="token-list">
                ...
                <div id="preferences-tab" class="tab-pane">
                    <div class="preferences-section">
                        ...
                        @if($profile->preferred_causes && count($profile->preferred_causes) > 0)
                            <div class="preference-item">
            ...
            <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="edit-form">
                ...
                <div class="form-tabs">
                    <button type="button" class="form-tab-btn active" onclick="switchFormTab('basic')">Basic Info</button>
                    <button type="button" class="form-tab-btn" onclick="switchFormTab('personal')">Personal</button>
                    <button type="button" class="form-tab-btn" onclick="switchFormTab('social')">Social & Links</button>
                    <button type="button" class="form-tab-btn" onclick="switchFormTab('settings')">Settings</button>
                </div>

                <!-- Basic Info Form -->
                <div id="basic-form" class="form-tab-content active">
                    <div class="input-row">
